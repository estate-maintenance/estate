...
$sql="Insert into sncomplaints(username, name,designation,location,Lab,Toilet,Office,Classroom,area,description,room,timing,timedesc,contact,email, descText) values('" . $_SESSION['user'] . "', '".mysql_real_escape_string($_POST['username'])."',";
			$sql.="'".mysql_real_escape_string($_POST['desig'])."'," ;
			$sql.="'".$_POST['location']."'," ;
                        $sql.="'".mysql_real_escape_string($_POST['dd1'])."',";
                        $sql.="'".mysql_real_escape_string($_POST['dd2'])."',";
                        $sql.="'".mysql_real_escape_string($_POST['dd3'])."',";
                        $sql.="'".mysql_real_escape_string($_POST['dd4'])."',";
			$sql.= $_POST['comlocation'] ;
			$sql.=",".$_POST['problem']."," ;
			$sql.="'".mysql_real_escape_string($_POST['room'])."',";
			$sql.=$_POST['timing'].",";	
                       $sql.="'".mysql_real_escape_string($_POST['tt4'])."',";
...
{	var f=document.form1
	var hr1=0,hr2=0,hr3=0,dr1=0,dr2=0,dr3=0,dr4=0
	...
	return hr1+hr2+hr3+dr1+dr2+dr3+dr4
...
{
	var f=document.form1
	var pr1=0,pr2=0,pr3=0,pr4=0,pr5=0,pr6=0,pr7=0,pr8=0,pr9=0,pr10=0
	...
	if(f.p6.checked)pr6=32
        ...
        if(f.p9.checked)pr8=256
        if(f.p10.checked)pr8=1024
	return pr1+pr2+pr3+pr4+pr5+pr6+pr7+pr8+pr9+pr10
}
...
function validate()
{
	...
	if(f.comlocation.value=="1")
	{
		if(f.roomno.value=="")
		{
			alert("Please enter Room No or Wing")
			f.roomno.focus()
			x = 0;
 ...
 if(f.comlocation.value=="3")
	{
		
		if(f.d1.checked && f.dd1.value=="")
		{	alert("Please write lab name")
			f.dd1.focus()
			x = 0;
			blinkBorder("white","red", f.dd1, 500);
			return false;
		}
             if(f.d2.checked && f.dd2.value=="")
		{	alert("Please write Toilets location")
			f.dd2.focus()
			x = 0;
			blinkBorder("white","red", f.dd2, 500);
			return false;
		}
              if(f.d3.checked && f.dd3.value=="")
		{	alert("Please write office name")
			f.dd3.focus()
			x = 0;
			blinkBorder("white","red", f.dd3, 500);
			return false;
		}
           if(f.d4.checked && f.dd4.value=="")
		{	alert("Please write classroom name")
			f.dd4.focus()
			x = 0;
			blinkBorder("white","red", f.dd4, 500);
			return false;
		}
	}
	...
	if(!f.t1.checked && !f.t2.checked && !f.t3.checked && !f.t4.checked)
	{
        ...
        if(f.t4.checked  && f.tt4.value=="")
		{	alert("Please write the available time")
			f.dd4.focus()
			x = 0;
			blinkBorder("white","red", f.tt4, 500);
			return false;
		}
	...
	if(!f.p1.checked && !f.p2.checked && !f.p3.checked && !f.p4.checked && !f.p5.checked && !f.p6.checked && !f.p7.checked && !f.p8.checked && !f.p9.checked && !f.p10.checked && !f.p11.checked)
	{
	...
	if(f.descBox.value=="" && f.p11.checked)
...
<h1 align="center">Sanitary Complaints</h1>
<table width="100%" align="center" border="0" cellpadding="5" cellspacing="5">
<tr align="center">
<td width="30%" align="right">Enter your name : </td>
<td id="userTbox"  align="left"><input type="text" name="username" size="12" /></td>
...
&nbsp;&nbsp;<br>&nbsp;<br>Room No./Wing: <input type="text" name="roomno" value=""size="2" /><br />
...
<br /><input type="checkbox" name="d1" value="1"  />Lab &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="textbox" name="dd1" size="7px"  /><br />
<input type="checkbox" name="d2" value="2"  />Toilets &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="textbox" name="dd2" size="7px"  /><br/>
<input type="checkbox" name="d3" value="4"   />Office &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="textbox" name="dd3" size="7px"  /><br/>
<input type="checkbox" name="d4" value="8" />Classroom &nbsp;<input type="textbox" name="dd4" size="7px"  /><br />
<br />
...
<input type="checkbox" name="t4" value="Other Time"  />Other Time<input type="textbox" name="tt4" size="2px"  /><br />
<br><input type="text" name="contact" size="12" /><br><br>&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="Submit" value="Submit" />
</td><td align="right"><br><br><br><br><br><br><br><br><br><br>Problem Description :</td>
<td align="left">
...
<input type="checkbox" name="p8" value="128" />Removal of Honeybees/Mosquitoes/dead.<br><br>
<input type="checkbox" name="p9" value="256" />Bush clean up.<br><br>
<input type="checkbox" name="p10" value="512" />Termites/Ants Treatment.<br><br>
<input type="checkbox" id = "descCheck" name="p11" value="1024" />Others<br>
