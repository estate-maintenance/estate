...
require_once('conn.php');
		...
		{
			$sql="Insert into elcomplaints(username, name,designation,location,Lab,Toilet,Office,Classroom,area,description,room,timing,timedesc,contact,email, descText) values('" . $_SESSION['user'] . "', '".mysql_real_escape_string($_POST['username'])."',";
...
<td>&nbsp;</td>
<td align="left" ><input type="text" name="otherdesignation" size="13" /></td>
</tr>
...
<!--<br /><input type="checkbox" name="o1" value="1"  />Office&nbsp;&nbsp;&nbsp;&nbsp;<input type="textbox" name="oo1" size="4px"  /><br />
<input type="checkbox" name="o2" value="2"  />Toilets&nbsp;&nbsp;&nbsp;<input type="textbox" name="oo2" size="4px"  /><br/>
<input type="checkbox" name="o3" value="4"  />Corridor&nbsp;<input type="textbox" name="oo3" size="4px"  /><br/>
<input type="checkbox" name="o4" value="8"  />Class&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="textbox" name="oo4" size="4px"  /><br/>-->
</div>
