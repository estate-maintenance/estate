...
require_once('conn.php');
		...
		{
$sql="Insert into cpcomplaints(username, name,designation,location,Lab,Toilet,Office,Classroom,area,description,room,timing,timedesc,contact,email, descText) values('" . $_SESSION['user'] . "', '".mysql_real_escape_string($_POST['username'])."',";
...
<input type="checkbox" name="p4" value="8" />Window handles/hooks/ventilator repair.<br><br><input type="checkbox" name="p5" value="16" />Replacement of Door/Window/Ventilator.</td>
</tr>
...
<td align="left">
<input type="checkbox" id = "descCheck" name="p6" value="32" />Door stoper problem.<br><br>
