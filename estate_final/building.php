...
require_once('conn.php');
		...
		{
$sql="Insert into blcomplaints(username, name,designation,location,Lab,Toilet,Office,Classroom,area,description,room,timing,timedesc,contact,email, descText) values('" . $_SESSION['user'] . "', '".mysql_real_escape_string($_POST['username'])."',";
...
<h1 align="center">Building Complaints</h1>
...
<td align="left">
<input type="checkbox" name="p1" value="1" /> Plastering.<br />
</td>
</tr>
<tr align="center">
...
<input type="checkbox" name="p2" value="2" />Fence.
</tr>
...
<input type="checkbox" name="p3" value="4" />Leakage.
</td>
</tr>
<tr align="center">
<td>&nbsp;</td>
...
<input type="checkbox" name="p4" value="8" />flooring.<br><br><input type="checkbox" name="p5" value="16" />Painting.</td>
</tr>
...
<td align="left">
<input type="checkbox" name="p6" value="32" />Others.
