...
$sql="Insert into wscomplaints(username, name,designation,location,Lab,Toilet,Office,Classroom,area,description,room,timing,timedesc,contact,email, descText) values('" . $_SESSION['user'] . "', '".mysql_real_escape_string($_POST['username'])."',";
...
<h1 align="center">Water Supply Complaints</h1>
...
<td align="left">
<input type="checkbox" name="p1" value="1" />No water supply.<br />
</td>
</tr>
<tr align="center">
...
<input type="checkbox" name="p2" value="2" />Water purity problem.
</tr>
...
<input type="checkbox" name="p3" value="4" /> Overflow of water.
</td>
</tr>
<tr align="center">
<td>&nbsp;</td>
...
<input type="checkbox" name="p4" value="8" />Cleaning of water tanks.<br><br><input type="checkbox" name="p5" value="16" />Leakage of pipes.</td>
</tr>
...
<input type="checkbox" name="p6" value="32" />Replacements of Taps/washbasins &nbsp;&nbsp;&nbsp;&nbsp;or pvc items.<br><br>
<input type="checkbox" name="p7" value="64" />Waste pipes removal.<br><br>
