...
echo "<p style='margin-top: 50px; margin-left:350px;'><b>SIGNATURE OF ATTENDANT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;STORES IN - CHARGE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ASSISTANT ENGINEER</b></p>";
		...
		{
			$sql="Select id,name,designation,department,location,description,processed,area,time, contactPerson, contactNumber, room,availablefrom,availableto,contact from complaints ";
			$status="and";
			$sql.="where ( 1=1 ";
		...
		$sql="Select id,name,designation,department,location,description,processed,area,time, contactPerson, contactNumber, room,timing,availablefrom,availableto,contact from complaints order by processed ASC";
